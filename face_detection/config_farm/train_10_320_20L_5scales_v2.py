...
param_trainset_pickle_file_path = os.path.join(os.path.dirname(__file__), '../data_provider_farm/widerface_train_data_gt_8.pkl')
...
param_enable_horizon_flip = True    # trigger for horizon flip
param_enable_vertical_flip = False     # trigger for vertical flip
...
param_enable_random_saturation = True#随机饱和
...
def run():
    ...
    # 构造dataiter
    from data_provider_farm.pic_provider import PickleProvider
